...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  {
    name: "seshat_index_status",
    description:
      "Get the status of a background indexing job by its jobId. Use this after calling seshat_index to check progress.",
    ...
    inputSchema: {
      ...
      properties: {
        jobId: {
          type: "string",
          description: "Job ID returned from seshat_index",
        },
      },
      required: ["jobId"],
    },
